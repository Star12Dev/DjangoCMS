# -*- coding: utf-8 -*-
# Generated by Django 1.11.15 on 2018-12-07 12:55
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            name='BleroGrid',
            fields=[
                ('cmsplugin_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, related_name='blero_grid_blerogrid', serialize=False, to='cms.CMSPlugin')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('model', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='blero_grid.BleroGrid')),
            ],
        ),
        migrations.CreateModel(
            name='GridColumns',
